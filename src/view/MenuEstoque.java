...
public class MenuEstoque {
    ...
    private static void alterarOutroItem() {
    if (!controller.estoqueVazio()) {
        System.out.println("Você deseja alterar outro item?");
        String continuar = read.nextLine();

        while (continuar.equalsIgnoreCase("sim")) {
            alterarEstoque();

            System.out.println("Você deseja alterar outro item? (sim/não)");
    ...
    private static void adicionarProdutos() {
        ...
        String nome = read.nextLine();
            if (!nome.matches("[A-Za-zÀ-ÿ ]+")) { //maneira que encontrei de evitar que sejam usados numeros e simbolos
...
//invoca alterarProduto do controller para alterar os atributps
 ...
 //verifica se o produto é válido
    ...
    private static void retirarProduto() {
        ...
        int quantidade = read.nextInt();
        read.nextLine();
        boolean existeproduto = controller.retirarProduto(nome, quantidade);
    ...
    private static void deletarProduto() {
        ...
        String nome = read.nextLine();
        boolean existeproduto = controller.deletarProduto(nome);
